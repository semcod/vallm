...
class Language(Enum):
    ...
    def from_string(cls, name: str) -> Optional[Language]:
        ...
        for lang in cls:
            if (
                lang.name.lower() == name_lower
                or lang.tree_sitter_id.lower() == name_lower
                or lang.display_name.lower() == name_lower
            ):
                return lang
...
EXTENSION_MAP: dict[str, Language] = {lang.extension: lang for lang in Language}
